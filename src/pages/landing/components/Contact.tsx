          ...
          <div className='relative z-[1] flex flex-col items-center mdl:items-end justify-center rounded-[2.5em] py-[1rem] mdl:py-[5rem] text-textWhite'>
            ...
            <div className='relative z-[1] flex w-full max-w-[44em] flex-col gap-y-[1rem] mdl:gap-y-[2rem] px-1'>
              ...
              <p className='my-0 inline-block text-[1em] mdl:text-[1.38em] leading-[1.4]'>
                <strong className='font-bold'>Try it 14 days for free</strong> -
                no credit card required.
              </p>
              <div className='max-w-[620px]'>
                <div className='relative flex min-w-[10em] mdl:min-w-[22em] max-w-full flex-1 flex-row items-center overflow-hidden rounded-[1rem] border-textPurpleBorder bg-white py-1  pl-1'>
                  <input
                  ...
                  />
                  <a
                    className='relative right-2 z-[1] flex min-h-[3.13em] min-w-[8em] cursor-pointer items-center justify-center gap-x-[0.5rem] overflow-hidden rounded-2xl bg-primary mdl:px-4 font-bold text-textWhite'
